...
public class ATMGUI {
    ...
    public ATMGUI(ATM atm) {
        ...
        Font buttonFont = new Font("Gupter", Font.BOLD, 30);
        ...
        resultLabel.setFont(new Font("Gupter", Font.BOLD, 24));
        ...
        withdrawButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (success) {
                        resultLabel.setText("Withdrawal successful. New balance is $" + atm.checkBalance());
                    } else {
                        resultLabel.setText("Insufficient funds. Current balance is $" + atm.checkBalance());
                    }
        ...
        depositButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    double amount = Double.parseDouble(amountString);
                    atm.deposit(amount);
                    resultLabel.setText("Deposit successful. New balance is $" + atm.checkBalance());
                } catch (NumberFormatException ex) {
                    resultLabel.setText("Invalid input! Please enter a valid number.");
                }
            }
        ...
        balanceButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                resultLabel.setText("Current balance is $" + atm.checkBalance());
            }
        });
        ...
        transferButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (success) {
                        resultLabel.setText("Transfer successful. New balance is $" + atm.checkBalance());
                    } else {
        ...
        exitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int option = JOptionPane.showConfirmDialog(frame, "Are you sure you want to exit? (Yes/No)", "Exit Confirmation", JOptionPane.YES_NO_OPTION);
